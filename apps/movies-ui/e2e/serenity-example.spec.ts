...
const MoviesNavigationTitle = PageElement.located(By.css("[data-testid='NavbarBrand']")).describedAs("movies navigation title");
const MoviesSearchField = PageElement.located(By.css("[data-testid='MovieSearchField']")).describedAs("movie search input");
